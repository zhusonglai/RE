...
#[derive(Debug)]
pub struct RESTfulAPIProcessor {
    verbose: bool,
    processed_count: usize,
}

impl RESTfulAPIProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting RESTfulAPI processing");
    
    let mut processor = RESTfulAPIProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = RESTfulAPIProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = RESTfulAPIProcessor::new(false);
